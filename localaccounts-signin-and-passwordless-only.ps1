...
$path = "./templates/b2c-custom-policy-generator/LocalAccounts/signin-and-passwordless-only/$signinPasswordless"
...
$path = "./templates/b2c-custom-policy-generator/LocalAccounts/signin-and-passwordless-only/$trustFrameworkExtensions"
