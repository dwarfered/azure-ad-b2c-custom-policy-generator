...
$path = "./templates/scenarios/LocalAccounts/signin-and-passwordless-only/$signinPasswordless"
...
$path = "./templates/scenarios/LocalAccounts/signin-and-passwordless-only/$trustFrameworkExtensions"
